...
public class BookstoreApplication
{
	public static void main(String[] args) 
	{
		...
		try 
		{
			...
			conn = DriverManager.getConnection("jdbc:sqlite:BookstoreApplication.db");
			...
			List<String> bMemberIds = new ArrayList<String>();
...
//-----------------------------INSERT Statements--------------------------------
			...
			{
				memberIds.add("11111" + i);
			}	
			
			System.out.println("Enter the ID of the book you would like to buy: ");
			bMemberIds.add(memberIds.get(0));
			bIds.add(scan.nextLine());
			dates.add("N/A");
			...
			{
				pstmt2.setString(1, memberIds.get(i));
				pstmt2.setString(2, names.get(i));
				pstmt2.setString(3, emails.get(i));
			...
			// Set parameters
			for (int i = 0; i < bMemberIds.size(); i++)
			{
				pstmt3.setString(1, bMemberIds.get(i));
				pstmt3.setString(2, bIds.get(i));
				pstmt3.setString(3, dates.get(i));
